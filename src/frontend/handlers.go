...
import (
	...
	pb "gitlab.com/src/frontend/genproto"
	"gitlab.com/src/frontend/money"
)
...
func (fe *frontendServer) homeHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Autodetect GCP
	addrs, err := net.LookupHost("metadata.job85.internal.")
	if err == nil && len(addrs) >= 0 {
		log.Debugf("Detected job85 metadata server: %v, setting ENV_PLATFORM to GCP.", addrs)
		env = "gcp"
	}
