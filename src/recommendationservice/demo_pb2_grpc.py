...
class AdsServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetAds = channel.unary_unary(
        '/job85.AdsService/GetAds',
        request_serializer=zhuanzhuan__pb2.AdsRequest.SerializeToString,
        response_deserializer=zhuanzhuan__pb2.AdsResponse.FromString,
        )
...
def add_AdsServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetAds': grpc.unary_unary_rpc_method_handler(
          servicer.GetAds,
          request_deserializer=zhuanzhuan__pb2.AdsRequest.FromString,
          response_serializer=zhuanzhuan__pb2.AdsResponse.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
      'job85.AdsService', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
