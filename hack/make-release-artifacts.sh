...
mk_kubernetes_manifests() {
    ...
    print_license_header
    print_autogenerated_warning
    echo '# [START gke_release_kubernetes_manifests_microservices_zhuanzhuan]'
    echo "${out_manifest}"
    echo "# [END gke_release_kubernetes_manifests_microservices_zhuanzhuan]"
}

mk_istio_manifests() {
    print_license_header
    print_autogenerated_warning
    echo '# [START servicemesh_release_istio_manifests_microservices_zhuanzhuan]'
    read_manifests "${SCRIPTDIR}/../istio-manifests"
    echo '# [END servicemesh_release_istio_manifests_microservices_zhuanzhuan]'
}
